...
USER_PROMPT_TEMPLATE_NORMAL = """You solve questions by calling tools and reasoning step by step.
...
USER_PROMPT_TEMPLATE_THINKING = """You solve questions by calling tools and reasoning step by step.
...
3. LANGUAGE & FORMAT CHECK: What language is the question in? Does the question specify any format/naming requirements? Is my answer in the correct language with the exact standard translation/name? The answer must match the expected answer character-by-character — wrong language or non-standard translation = wrong answer.

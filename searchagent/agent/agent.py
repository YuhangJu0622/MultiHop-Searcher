...
class AgentInterface:
    ...
    def get_answer(self, message: str, solve_method='iterative', deep_reasoning=False, history=''):
        ...
        if history:
            ...
            context = message
        logger.info("[AgentInterface] solve_method=%s, deep_reasoning=%s", solve_method, deep_reasoning)
        ...
        try:
            ...
            logger.warning("[AgentInterface] agent error: %s: %s", type(e).__name__, e)
            raise
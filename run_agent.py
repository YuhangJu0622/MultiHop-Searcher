...
Usage:
    python run_agent.py --data data_stage_1.jsonl --output results.jsonl
    python run_agent.py --data data_stage_1.jsonl --start 0 --end 50 --concurrency 3
"""
import argparse
import asyncio
import json
...
from logger_config import current_qid, setup_eval_logging
...
async def main():
    ...
    parser.add_argument("--output", default="results.jsonl", help="Path to output results JSONL")
